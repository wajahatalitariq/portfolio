...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var passwordHash, skillCount, projectCount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcryptjs_1.default.hash('BS-it_8048', 10)];
                case 1:
                    ...
                    return [4 /*yield*/, prisma.user.upsert({
                        ...
                        // Basic initial skill seeding to not be empty
                    ];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, prisma.skill.count()];
                case 3:
                    skillCount = _a.sent();
                    if (!(skillCount === 0)) return [3 /*break*/, 5];
                ...
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5: return [4 /*yield*/, prisma.project.count()];
                case 6:
                    projectCount = _a.sent();
                    if (!(projectCount === 0)) return [3 /*break*/, 8];
